...
<a href="{{url("add_item")}}">New post</a>
<br></br>
  @if ($items)
    ...
    @foreach($items as $item)
                    ...
                    <div class="card-body">
                        <div class="text-muted h7 mb-2"> <i class="fa fa-clock-o"></i>{{$item->Datee}}</div>
                            <h5 class="card-title"><a href="{{url("item_detail/$item->id")}}">{{$item->summary}}</a></h5>
                        </a>

                        <p class="card-text">
                        {{$item->details}}
                        </p>
                        <p class="card-title"><a href="{{url("item_detail/$item->id")}}">Comments (2)</a></p>
                    </div>
                </div>
                <!-- Post /////-->
      <br></br>
